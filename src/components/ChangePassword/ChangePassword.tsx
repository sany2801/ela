        ...
        <>
            {!isSuccess &&
                <form className="change-password__form">
                    <h3 className="change-password__form-header">Change your password</h3>
            ...
            {isSuccess &&
                <div className="success__wrapper">
                    <svg className="success-svg" width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="success">
                    ...
                    <p className="success-text">Your password has been successfully changed!</p>
                </div>
            }
        </>
    )
